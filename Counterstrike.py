...
async def start_knife_round(instance_name: str) -> Dict[str, Union[str, dict]]:
    ...
    commands = [
        ...
        "mp_freezetime 1",  # Set freeze time to 1 second
        "ammo_grenade_limit_total 0",  # Disable grenades
        "mp_warmuptime 0",  # Disable warmup time
        "mp_startmoney 0",  # Set starting money to 0
        "bot_quota 0",  # Disable bots
        "mp_buytime 0",  # Disable buy time
        "mp_free_armor 1",  # Enable free armor
        "mp_friendlyfire 0",  # Disable friendly fire
        "mp_weapons_allow_zeus 0",  # Disable Zeus
        "sv_allow_votes 0",  # Disable voting
        "sv_deadtalk 0",  # Disable dead chat
        "mp_weapons_allow_map_placed 0",  # Disable map-placed weapons
        "mp_give_player_c4 0",  # Disable giving C4
        "mp_maxmoney 0",  # Set max money to 0
...
async def stop_knife_round(instance_name: str) -> Dict[str, Union[str, dict]]:
    ...
    commands = [
        ...
        "mp_roundtime_defuse 1.75",  # Set round time to normal (1.75 minutes)
        "mp_freezetime 6",  # Set freeze time to normal (6 seconds)
        "ammo_grenade_limit_total 2",  # Allow a normal limit on grenades
        "mp_warmuptime 30",  # Set warmup time to normal (30 seconds)
        "mp_startmoney 800",  # Set starting money to normal (800)
        "mp_buytime 0.25",  # Re-enable buy time for 0.25 seconds
        "mp_free_armor 0",  # Disable free armor
        "mp_friendlyfire 1",  # Enable friendly fire (if desired)
        "mp_weapons_allow_zeus 1",  # Allow Zeus (if desired)
        "sv_allow_votes 1",  # Enable voting
        "sv_deadtalk 1",  # Enable dead chat
        "mp_weapons_allow_map_placed 1",  # Allow map-placed weapons
        "mp_give_player_c4 1",  # Enable giving C4
        "mp_maxmoney 16000",  # Set max money to the default (16000)
        "mp_restartgame 1",  # Restarts round
